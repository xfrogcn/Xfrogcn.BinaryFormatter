...
namespace Xfrogcn.BinaryFormatter.Resources {
    ...
    internal class Strings {
        ...
        /// <summary>
        ///   查找类似 Deserialization can not find the type,  assembly name is &apos;{0}&apos; 的本地化字符串。
        /// </summary>
        internal static string DeserializeCannotFindType {
            get {
                return ResourceManager.GetString("DeserializeCannotFindType", resourceCulture);
            }
        }
